...
excerpt: 'A hierarchical State Space Model (SSM) architecture integrating 2D Deep Delta Learning, achieving 510 FPS and outperforming ResNet50 by 13.1x in deployment efficiency for satellite edge computing.'
date: 2026-06-01
venue: 'Accepted at IEEE CONECCT'
paperurl: 'https://github.com/Latchan-Ch/DDV-Mamba_for_Efficient_Remote_Sensing'
citation: 'L. Chhetri, A. Kumar, G. Sarma. (2026). &quot;Deep Delta Vision Mamba: A Lightweight State Space Architecture with Deep Delta Learning for Efficient Remote Sensing.&quot; <i>IEEE CONECCT</i>.'
---
