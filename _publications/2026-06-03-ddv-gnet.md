...
permalink: /publication/2026-ddv-gnet
excerpt: 'A novel hierarchical gated convolutional architecture achieving real-time processing (853 FPS) and 95.9% accuracy for space manufacturing defect detection.'
date: 2026-06-03
venue: 'Accepted for Oral Presentation at IEEE SPACE'
paperurl: 'https://github.com/Latchan-Ch/DDV-GNet-Space'
citation: 'L. Chhetri, A. Kumar. (2026). &quot;DDV-GNet: High-Throughput Defect Detection for Space Manufacturing via Deep Delta Gated Networks.&quot; <i>IEEE SPACE</i>.'
---
...
### Code & Resources
* [Official PyTorch Implementation (GitHub)](https://github.com/Latchan-Ch/DDV-GNet-Space)
